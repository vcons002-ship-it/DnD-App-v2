...
export const STARTER_APPEARANCES: Record<string, [string, string, string[]]> = {
  ...
  Scout: ['scout', 'Medium', ['humanoid', 'scout']],
  Veteran: ['veteran', 'Medium', ['humanoid', 'soldier']],
  ...
  'Bandit Captain': ['bandit-captain', 'Medium', ['humanoid', 'bandit', 'leader']],
  ...
  Cultist: ['cultist', 'Medium', ['cultist']],
