...
const MASTERIES: MasteryEntry[] = [
  {
    ...
    mastery: { weapons: [], active: true, effect: { grazeOnMiss: true } },
  },
  {
    name: 'Cleave',
    type: 'mastery',
    ...
    mastery: { weapons: [], active: false, effect: { cleave: true } },
  },
  {
    name: 'Nick',
    type: 'mastery',
  ...
  },
  {
    ...
    mastery: { weapons: [], active: true, effect: { profBonusDamage: true } },
  },
];
